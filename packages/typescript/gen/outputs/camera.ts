...
export const CanvasObject: MessageFns<CanvasObject> = {
  encode(message: CanvasObject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.line !== undefined) {
      CanvasObject_Line.encode(message.line, writer.uint32(10).fork()).join();
    }
    if (message.rectangle !== undefined) {
      CanvasObject_Rectangle.encode(message.rectangle, writer.uint32(18).fork()).join();
    }
    if (message.circle !== undefined) {
      CanvasObject_Circle.encode(message.circle, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const CanvasObject_Color: MessageFns<CanvasObject_Color> = {
  encode(message: CanvasObject_Color, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.r !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanvasObject_Color {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CanvasObject_Line: MessageFns<CanvasObject_Line> = {
  encode(message: CanvasObject_Line, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.start !== undefined) {
      CanvasObject_Point.encode(message.start, writer.uint32(10).fork()).join();
    }
    if (message.end !== undefined) {
      CanvasObject_Point.encode(message.end, writer.uint32(18).fork()).join();
    }
    if (message.width !== 0) {
      writer.uint32(24).uint32(message.width);
    }
    if (message.color !== undefined) {
      CanvasObject_Color.encode(message.color, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanvasObject_Line {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CanvasObject_Rectangle: MessageFns<CanvasObject_Rectangle> = {
  encode(message: CanvasObject_Rectangle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topLeft !== undefined) {
      CanvasObject_Point.encode(message.topLeft, writer.uint32(10).fork()).join();
    }
    if (message.bottomRight !== undefined) {
      CanvasObject_Point.encode(message.bottomRight, writer.uint32(18).fork()).join();
    }
    if (message.width !== 0) {
      writer.uint32(24).uint32(message.width);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanvasObject_Rectangle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CameraSensorOutput: MessageFns<CameraSensorOutput> = {
  encode(message: CameraSensorOutput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.trajectory !== undefined) {
      CameraSensorOutput_Trajectory.encode(message.trajectory, writer.uint32(10).fork()).join();
    }
    if (message.debugFrame !== undefined) {
      CameraSensorOutput_DebugFrame.encode(message.debugFrame, writer.uint32(18).fork()).join();
    }
    if (message.objects !== undefined) {
      CameraSensorOutput_Objects.encode(message.objects, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const CameraSensorOutput_Trajectory: MessageFns<CameraSensorOutput_Trajectory> = {
  encode(message: CameraSensorOutput_Trajectory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.points) {
      CameraSensorOutput_Trajectory_Point.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.width !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CameraSensorOutput_Trajectory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CameraSensorOutput_Trajectory_Point: MessageFns<CameraSensorOutput_Trajectory_Point> = {
  encode(message: CameraSensorOutput_Trajectory_Point, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CameraSensorOutput_Trajectory_Point {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CameraSensorOutput_DebugFrame: MessageFns<CameraSensorOutput_DebugFrame> = {
  encode(message: CameraSensorOutput_DebugFrame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CameraSensorOutput_DebugFrame {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CameraSensorOutput_Objects: MessageFns<CameraSensorOutput_Objects> = {
  encode(message: CameraSensorOutput_Objects, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CameraSensorOutput_Objects {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
