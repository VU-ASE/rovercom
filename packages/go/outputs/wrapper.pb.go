...
type SensorOutput struct {
	...
	//	*SensorOutput_GenericStringScalar
	//	*SensorOutput_GenericIntArray
	//	*SensorOutput_GenericFloatArray
...
func (x *SensorOutput) GetGenericIntScalar() *GenericIntScalar {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericIntScalar); ok {
			return x.GenericIntScalar
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericFloatScalar() *GenericFloatScalar {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericFloatScalar); ok {
			return x.GenericFloatScalar
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericBoolScalar() *GenericBoolScalar {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericBoolScalar); ok {
			return x.GenericBoolScalar
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericStringScalar() *GenericStringScalar {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericStringScalar); ok {
			return x.GenericStringScalar
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericIntArray() *GenericIntArray {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericIntArray); ok {
			return x.GenericIntArray
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericFloatArray() *GenericFloatArray {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericFloatArray); ok {
			return x.GenericFloatArray
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericBoolArray() *GenericBoolArray {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericBoolArray); ok {
			return x.GenericBoolArray
		}
	}
	return nil
}

func (x *SensorOutput) GetGenericStringArray() *GenericStringArray {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_GenericStringArray); ok {
			return x.GenericStringArray
		}
	}
	return nil
}

func (x *SensorOutput) GetLidarOutput() *LidarSensorOutput {
	if x != nil {
		if x, ok := x.SensorOutput.(*SensorOutput_LidarOutput); ok {
			return x.LidarOutput
		}
	}
	return nil
}
...
type SensorOutput_GenericIntScalar struct {
	GenericIntScalar *GenericIntScalar `protobuf:"bytes,13,opt,name=genericIntScalar,proto3,oneof"`
}

type SensorOutput_GenericFloatScalar struct {
	GenericFloatScalar *GenericFloatScalar `protobuf:"bytes,14,opt,name=genericFloatScalar,proto3,oneof"`
}

type SensorOutput_GenericBoolScalar struct {
	GenericBoolScalar *GenericBoolScalar `protobuf:"bytes,15,opt,name=genericBoolScalar,proto3,oneof"`
}

type SensorOutput_GenericStringScalar struct {
	GenericStringScalar *GenericStringScalar `protobuf:"bytes,16,opt,name=genericStringScalar,proto3,oneof"`
}

type SensorOutput_GenericIntArray struct {
	GenericIntArray *GenericIntArray `protobuf:"bytes,17,opt,name=genericIntArray,proto3,oneof"`
}

type SensorOutput_GenericFloatArray struct {
	GenericFloatArray *GenericFloatArray `protobuf:"bytes,18,opt,name=genericFloatArray,proto3,oneof"`
}

type SensorOutput_GenericBoolArray struct {
	GenericBoolArray *GenericBoolArray `protobuf:"bytes,19,opt,name=genericBoolArray,proto3,oneof"`
}

type SensorOutput_GenericStringArray struct {
	GenericStringArray *GenericStringArray `protobuf:"bytes,20,opt,name=genericStringArray,proto3,oneof"`
}

type SensorOutput_LidarOutput struct {
...
func (*SensorOutput_GenericFloatScalar) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericBoolScalar) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericStringScalar) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericIntArray) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericFloatArray) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericBoolArray) isSensorOutput_SensorOutput() {}

func (*SensorOutput_GenericStringArray) isSensorOutput_SensorOutput() {}
...
const file_outputs_wrapper_proto_rawDesc = "" +
	...
	"\x13genericStringScalar\x18\x10 \x01(\v2\".protobuf_msgs.GenericStringScalarH\x00R\x13genericStringScalar\x12J\n" +
	"\x0fgenericIntArray\x18\x11 \x01(\v2\x1e.protobuf_msgs.GenericIntArrayH\x00R\x0fgenericIntArray\x12P\n" +
...
func file_outputs_wrapper_proto_init() {
	...
	file_outputs_wrapper_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SensorOutput_GenericStringScalar)(nil),
		(*SensorOutput_GenericIntArray)(nil),
		(*SensorOutput_GenericFloatArray)(nil),
